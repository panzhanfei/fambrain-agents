...
const AdminUsersPage = async () => {
    ...
    if (!session)
        redirect("/login");
    return (<div className="mx-auto flex min-h-dvh max-w-4xl flex-col gap-6 px-4 py-8 sm:px-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link href="/" className="rounded-full border border-[#e5e7eb] px-4 py-2 text-center text-[13px] font-medium text-[#374151] hover:bg-[#f9fafb]">
          返回对话
        </Link>
      </header>
