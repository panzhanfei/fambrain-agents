...
const PendingPage = async () => {
    ...
    return (<div className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-12">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <Link href="/login" className="rounded-full bg-[#4f46e5] px-5 py-2 text-[13px] font-semibold text-white hover:bg-[#4338ca]">
          重新登录刷新状态
        </Link>
        <LogoutLink />
      </div>
