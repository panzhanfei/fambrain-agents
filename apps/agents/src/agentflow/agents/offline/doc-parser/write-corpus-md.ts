...
export const buildCorpusMarkdown = (parsed: ParsedDocument): string => {
...
export const writeParsedToCorpus = async (corpusUserId: string, category: CorpusCategory, mdFileName: string, parsed: ParsedDocument): Promise<string> => {
