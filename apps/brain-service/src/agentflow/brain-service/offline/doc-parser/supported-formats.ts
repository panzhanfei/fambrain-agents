...
export const detectDocFormat = (fileName: string): DocParseFormat => {
...
export const isSupportedDocFile = (fileName: string): boolean => {
    return detectDocFormat(fileName) !== "unsupported";
};
export const slugifyBaseName = (fileName: string): string => {
