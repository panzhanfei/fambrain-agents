...
/** 知识库根目录（仓库内 `src/doc`） */
export const DOC_ROOT = path.join(process.cwd(), "src/doc");
 ...
 * 优先级：users/id/corpus → users/id 直下（过渡）→ src/doc 根下扁平（旧版）。
 */
